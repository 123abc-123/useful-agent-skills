...
MCP 配置、密钥、供应链完整性和 Agent 安全基线。 机器可读数据见 [`content/data/tools/skill-security.json`](../../../data/tools/skill-security.json)，网页入口见 [Skill Security](https://123abc-123.github.io/useful-agent-skills/tools/skill-security/)。
...
| 我的需求 | 推荐路径 |
|---|---|
| 审查 MCP 与 Agent 权限 | [按需求查看首选与备选](https://123abc-123.github.io/useful-agent-skills/tools/skill-security/?task=mcp#results) |
| 安装前检查依赖和 Skill 来源 | [按需求查看首选与备选](https://123abc-123.github.io/useful-agent-skills/tools/skill-security/?task=supply#results) |
